...
brief: These tests will check if the IP blocking feature of the API handled by the 'shieldnet-defend-apid' daemon
       is working properly. The ShieldnetDefend API is an open source 'RESTful' API that allows for interaction
...
references:
    ...
    - https://documentation.shieldnetdefend.com/current/user-manual/api/configuration.html#access
...
from shieldnet_defend_testing.modules.api.patterns import API_LOGIN_ERROR_MSG
