...
brief: These tests will check if the 'DOS' (Denial-of-service attack) blocking feature of the API handled
       by the 'shieldnet-defend-apid' daemon is working properly. The ShieldnetDefend API is an open source 'RESTful' API
...
from shieldnet_defend_testing.constants.api import CONFIGURATION_TYPES, AGENTS_ROUTE
