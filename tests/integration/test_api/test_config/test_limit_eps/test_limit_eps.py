...
def test_limit_eps(test_configuration, test_metadata, set_shieldnet_defend_configuration, add_configuration,
    ...
    assert f"<maximum>{test_metadata['expected_max_value']}</maximum>" in shieldnet_defend_config
    assert f"<timeframe>{test_metadata['expected_timeframe_value']}</timeframe>" in shieldnet_defend_config
