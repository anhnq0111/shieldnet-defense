...
def test_upload_configuration(test_configuration, test_metadata, backup_shieldnet_defend_configuration, add_configuration,
    ...
    parameters:
        ...
        - backup_shieldnet_defend_configuration:
            type: fixture
            brief: Save the initial shieldnetdefend configuration and restore it after the test.
        - add_configuration:
            type: fixture
