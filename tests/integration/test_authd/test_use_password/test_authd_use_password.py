...
def read_random_pass():
    """
    Search for the random password creation in ShieldnetDefend logs
    """
    passw = None
    try:
        with open(SHIELDNET_DEFEND_LOG_PATH, 'r') as log_file:
...
def test_authd_use_password(test_configuration, test_metadata, set_shieldnet_defend_configuration,
