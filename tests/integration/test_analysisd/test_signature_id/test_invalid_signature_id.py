...
def test_invalid_signature_id(test_configuration, test_metadata, set_shieldnet_defend_configuration, truncate_monitored_files,
    ...
    '''
    # Start monitor
    monitor_invalid = file_monitor.FileMonitor(SHIELDNET_DEFEND_LOG_PATH)
