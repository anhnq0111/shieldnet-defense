...
def test_enabled(test_configuration, test_metadata, load_shieldnet_defend_basic_configuration, set_shieldnet_defend_configuration,
...
def test_disabled(test_configuration, test_metadata, load_shieldnet_defend_basic_configuration, set_shieldnet_defend_configuration,
                 truncate_monitored_files, daemons_handler):
    """
    ...
    """
    # Start monitor
    monitor_disabled = file_monitor.FileMonitor(SHIELDNET_DEFEND_LOG_PATH)
