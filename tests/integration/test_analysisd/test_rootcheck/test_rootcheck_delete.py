...
def test_rootcheck_delete(test_configuration, test_metadata, set_shieldnet_defend_configuration,
    ...
    expected_output:
        - ShieldnetDefend DB returned an error trying to delete the agent
    ...
    for agent in agents:
        ...
        assert response.startswith(b'ok'), "ShieldnetDefend DB returned an error " \
