...
brief: The 'shieldnet-defend-analysisd' daemon receives the log messages and compares them to the rules.
       ...
       Specifically, these tests will check if the 'shieldnet-defend-analysisd' daemon correctly handles
...
def test_scan_messages(test_metadata, configure_local_internal_options, configure_sockets_environment_module,
    ...
    '''
    description: Check if when the 'shieldnet-defend-analysisd' daemon socket receives a message with
                 a file scanning-related event, it generates the corresponding alert
                 that sends to the 'shieldnet-defend-db' daemon socket.
