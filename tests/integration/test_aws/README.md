...
It is a _wodle based_ module that tests the capabilities of the ShieldnetDefend AWS integration, pulling logs from different
buckets and services.

## Tests directory structure

```bash
shieldnetdefend/tests/integration/test_aws
├── data
...
- [ShieldnetDefend](https://github.com/shieldnetdefend/qa-integration-framework) repository.

- [Testing framework](https://github.com/shieldnetdefend/qa-integration-framework) installed.
...
- **Credentials**:
 ...
 more information [here](https://documentation.shieldnetdefend.com/current/amazon/services/prerequisites/credentials.html#profiles) with the content:
...
the correct version (ShieldnetDefend branch).

_We are skipping ShieldnetDefend installation steps. For further information,
check [ShieldnetDefend documentation](https://documentation.shieldnetdefend.com/current/installation-guide/index.html)._
...
- Install Python tests dependencies:
    ...
    # Clone `shieldnetdefend` repository within your testing environment
    git clone https://github.com/shieldnetdefend/shieldnetdefend.git

    # Clone the `qa-integration-framework` repository withing your testing environment
    git clone https://github.com/shieldnetdefend/qa-integration-framework.git
...
```shell script
    cd shieldnetdefend/tests/integration/test_aws/
```
...
```bash
#root@shieldnet-defend-master:/shieldnetdefend/tests/integration# pytest -x test_aws/ --disable-warnings
==================================== test session starts ====================================
platform linux -- Python 3.10.12, pytest-7.1.2, pluggy-1.2.0
rootdir: /shieldnetdefend/tests/integration, configfile: pytest.ini
