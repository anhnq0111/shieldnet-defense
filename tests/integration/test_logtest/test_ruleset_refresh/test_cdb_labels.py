...
references:
    ...
    - https://documentation.shieldnetdefend.com/current/user-manual/ruleset/cdb-list.html
...
def test_cdb_list(test_configuration, test_metadata, set_shieldnet_defend_configuration,
