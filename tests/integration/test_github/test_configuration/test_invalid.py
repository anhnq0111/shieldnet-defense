...
brief: The ShieldnetDefend 'github' module allows you to collect all the 'audit logs' from GitHub using its API.
...
references:
    - https://github.com/shieldnetdefend/shieldnet-defend-documentation/blob/develop/source/github/monitoring-github-activity.rst
