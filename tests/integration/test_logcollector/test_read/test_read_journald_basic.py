...
def test_configuration_location(test_configuration, test_metadata, truncate_monitored_files, configure_local_internal_options,
                                remove_all_localfiles_shieldnet_defend_config, set_shieldnet_defend_configuration, daemons_handler, wait_for_logcollector_start):
    '''
    description: Check if the 'shieldnet-defend-logcollector' daemon starts properly when the 'journald' tag is used and read the logs from the 'systemd/journald' component.
    ...
    assertions:
        ...
        - Verify that the ShieldnetDefend component (agent or manager) can read the logs from the 'systemd-journald'.
