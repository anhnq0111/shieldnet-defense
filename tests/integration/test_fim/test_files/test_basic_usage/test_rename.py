...
def test_rename(test_configuration, test_metadata, set_shieldnet_defend_configuration, configure_local_internal_options,
                truncate_monitored_files, folder_to_monitor, daemons_handler, start_monitoring, path_to_edit):
    '''
    description: Check if the 'shieldnet-defend-syscheckd' daemon detects 'added' and 'deleted' events when renaming a
