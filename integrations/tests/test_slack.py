...
options_template = {'pretext': 'Shieldnet-Defend-X -- Alert generated', 'author_name': 'The amazing ShieldnetDefend', 'footer': 'Slack API'}

msg_template = (
    '{"severity": 1, "pretext": "Shieldnet-Defend-X -- Alert generated", "title": "alert description", "text": "full log.", '
    ...
    '"full log.", "decoder": {"name": "decoder-name"}, "location": "shieldnet-defend-X", "author_name": "The amazing ShieldnetDefend",'
    '"footer": "Slack API"}'
)
slack_webhook = ''
