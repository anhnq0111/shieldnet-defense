...
from shieldnetdefend.rbac.orm import RolesManager, TokenManager, check_database_integrity, DB_FILE
...
def update_security_conf(new_config: dict):
    ...
    if new_config:
        try:
            ...
            raise ShieldnetDefendInternalError(1005)
    else:
        raise ShieldnetDefendError(4021)
