...
from shieldnetdefend.core.utils import ShieldnetDefendDBQuery, ShieldnetDefendDBBackend, get_utc_strptime
from shieldnetdefend.core.utils import process_array

# Default request_slice value
DEFAULT_REQUEST_SLICE = 500

# Optimal request_slice values for each ShieldnetDefendDBQuery
# TACTICS_REQUEST_SLICE = 500  # Default ShieldnetDefendDBQueryMitre request_slice value
...
class ShieldnetDefendDBQueryMitre(ShieldnetDefendDBQuery):
    ...
    def __init__(self, offset: int = 0, limit: Union[int, None] = common.DATABASE_LIMIT, query: str = '',
                 ...
                 distinct: bool = False):
        """Create an instance of the ShieldnetDefendDBQueryMitre class.
        ...
        request_slice : int
            Max limit used in the ShieldnetDefendDBBacked backend object.
        distinct : bool
        ...
        ShieldnetDefendDBQuery.__init__(self, offset=offset, limit=limit, table=table, sort=sort, search=search, select=select,
                              ...
                              backend=ShieldnetDefendDBBackend(query_format='mitre', request_slice=request_slice),
                              distinct=distinct)
...
class ShieldnetDefendDBQueryMitreMetadata(ShieldnetDefendDBQueryMitre):
    """Class that handles the MITRE metadata."""

    TABLE_NAME = 'metadata'

    def __init__(self):
        """Create an instance of the ShieldnetDefendDBQueryMitreMetadata class."""

        min_select_fields = {'key', 'value'}
        fields = {'key': 'key', 'value': 'value'}

        ShieldnetDefendDBQueryMitre.__init__(self, table=self.TABLE_NAME, min_select_fields=min_select_fields, fields=fields,
...
class ShieldnetDefendDBQueryMitreRelational(ShieldnetDefendDBQueryMitre, ABC):
    """Abstract class used to overload the _format_data_into_dictionary method of ShieldnetDefendDBQueryMitre.
...
class ShieldnetDefendDBQueryMitreRelationalPhase(ShieldnetDefendDBQueryMitreRelational):
    ...
    def __init__(self, offset: int = 0, limit: Union[int, None] = None, query: str = '', count: bool = True,
        ...
        """Create an instance of the ShieldnetDefendDBQueryMitreRelationalPhase class.
...
class ShieldnetDefendDBQueryMitreRelationalMitigate(ShieldnetDefendDBQueryMitreRelational):
    ...
    def __init__(self, offset: int = 0, limit: Union[int, None] = None, query: str = '', count: bool = True,
                 ...
                 fields: dict = None, search: dict = None, select: list = None, min_select_fields: set = None,
                 filters: dict = None, dict_key: str = None, request_slice: int = DEFAULT_REQUEST_SLICE):
        """Create an instance of the ShieldnetDefendDBQueryMitreRelationalMitigate class.
...
class ShieldnetDefendDBQueryMitreRelationalUse(ShieldnetDefendDBQueryMitreRelational):
...
class ShieldnetDefendDBQueryMitreMitigations(ShieldnetDefendDBQueryMitre):
    ...
    def __init__(self, offset: int = 0, limit: Union[int, None] = common.DATABASE_LIMIT, query: str = '',
        ...
        """Create an instance of the ShieldnetDefendDBQueryMitreMitigations class.
        ...
        ShieldnetDefendDBQueryMitre.__init__(self, table=self.TABLE_NAME, min_select_fields=self.min_select_fields,
    ...
    def _execute_data_query(self):
        ...
        with ShieldnetDefendDBQueryMitreRelationalMitigate() as mitre_relational_query:
            techniques = mitre_relational_query.run()

        with ShieldnetDefendDBQueryMitreReferences(limit=None, filters={'type': 'mitigation'},
...
class ShieldnetDefendDBQueryMitreReferences(ShieldnetDefendDBQueryMitre):
    ...
    def __init__(self, offset: int = 0, limit: Union[int, None] = common.DATABASE_LIMIT, query: str = '',
                 ...
                 fields: dict = None, search: dict = None, select: list = None, min_select_fields: set = None,
                 filters: dict = None):
        """Create an instance of the ShieldnetDefendDBQueryMitreReferences class.
...
class ShieldnetDefendDBQueryMitreTactics(ShieldnetDefendDBQueryMitre):
    ...
    def __init__(self, offset: int = 0, limit: Union[int, None] = common.DATABASE_LIMIT, query: str = '',
                 ...
                 fields: dict = None, search: dict = None, select: list = None, min_select_fields: set = None,
                 filters: dict = None, distinct: bool = False):
        """Create an instance of the ShieldnetDefendDBQueryMitreTactics class.
    ...
    def _execute_data_query(self):
        ...
        with ShieldnetDefendDBQueryMitreRelationalPhase() as mitre_relational_query:
            techniques = mitre_relational_query.run()

        with ShieldnetDefendDBQueryMitreReferences(limit=None, filters={'type': 'tactic'},
                                         select=SELECT_FIELDS_REFERENCES) as mitre_references_query:
            references = mitre_references_query.run()
...
class ShieldnetDefendDBQueryMitreTechniques(ShieldnetDefendDBQueryMitre):
    ...
    def __init__(self, offset: int = 0, limit: Union[int, None] = common.DATABASE_LIMIT, query: str = '',
                 ...
                 fields: dict = None, search: dict = None, select: list = None, min_select_fields: set = None,
                 filters: dict = None, distinct: bool = False):
        """Create an instance of the ShieldnetDefendDBQueryMitreTechniques class.
    ...
    def _execute_data_query(self):
        ...
        with ShieldnetDefendDBQueryMitreRelationalPhase(dict_key='tech_id') as mitre_relational_query:
            tactics = mitre_relational_query.run()

        with ShieldnetDefendDBQueryMitreRelationalMitigate(dict_key='target_id') as mitre_relational_query:
            mitigations = mitre_relational_query.run()

        with ShieldnetDefendDBQueryMitreRelationalUse(filters={'target_type': 'technique', 'source_type': 'software'},
                                            dict_key='target_id',
                                            select=['source_id', 'target_id']) as mitre_relational_query:
            software = mitre_relational_query.run()

        with ShieldnetDefendDBQueryMitreRelationalUse(filters={'target_type': 'technique', 'source_type': 'group'},
        ...
        with ShieldnetDefendDBQueryMitreReferences(limit=None, filters={'type': 'technique'},
                                         select=SELECT_FIELDS_REFERENCES) as mitre_references_query:
            references = mitre_references_query.run()
...
class ShieldnetDefendDBQueryMitreGroups(ShieldnetDefendDBQueryMitre):
    ...
    def __init__(self, offset: int = 0, limit: Union[int, None] = common.DATABASE_LIMIT, query: str = '',
                 ...
                 fields: dict = None, search: dict = None, select: list = None, min_select_fields: set = None,
                 filters: dict = None, distinct: bool = False):
        """Create an instance of the ShieldnetDefendDBQueryMitreGroups class.
        ...
        ShieldnetDefendDBQueryMitre.__init__(self, table=f"`{self.TABLE_NAME}`", min_select_fields=self.min_select_fields,
                                   fields=self.fields, filters=filters, offset=offset, limit=limit, query=query,
                                   count=count, sort=sort, default_sort_field=default_sort_field,
                                   default_sort_order=default_sort_order, search=search,
                                   select=list(set(self.fields.values()).intersection(set(select))),
    ...
    def _execute_data_query(self):
        ...
        with ShieldnetDefendDBQueryMitreRelationalUse(filters={'target_type': 'software', 'source_type': 'group'},
                                            select=['source_id', 'target_id']) as mitre_relational_query:
            software = mitre_relational_query.run()
        ...
        with ShieldnetDefendDBQueryMitreReferences(limit=None, filters={'type': 'group'},
                                         select=SELECT_FIELDS_REFERENCES) as mitre_references_query:
            references = mitre_references_query.run()
...
class ShieldnetDefendDBQueryMitreSoftware(ShieldnetDefendDBQueryMitre):
    ...
    def _execute_data_query(self):
        ...
        with ShieldnetDefendDBQueryMitreReferences(limit=None, filters={'type': 'software'},
                                         select=SELECT_FIELDS_REFERENCES) as mitre_references_query:
            references = mitre_references_query.run()
...
def get_mitre_items(mitre_class: callable) -> tuple:
    ...
    mitre_class : callable
        ShieldnetDefendDBQueryMitre class used to obtain certain MITRE resources.
