...
from shieldnetdefend.core.cluster import __version__
from shieldnetdefend.core.common import AGENT_NAME_LEN_LIMIT, MAX_GROUPS_PER_MULTIGROUP, MAX_SOCKET_BUFFER_SIZE

GENERIC_ERROR_MSG = "ShieldnetDefend Internal Error. See log for more detail"
DOCU_VERSION = 'current' if __version__ == '' else '.'.join(__version__.split('.')[:2]).lstrip('v')

class ShieldnetDefendException(Exception):
    """
    ShieldnetDefend Exception object.
    """

    ERRORS = {
        # < 999: API
        900: 'One of the API child processes terminated abruptly. The API process pool is not usable anymore. '
             'Please restart the ShieldnetDefend API',
        901: 'API executor subprocess broke. A service restart may be needed',
        902: 'API Endpoint only available on master node',

        # ShieldnetDefend: 0999 - 1099
        999: 'Incompatible version of Python',
        1000: {'message': 'ShieldnetDefend Internal Error',
               'remediation': 'Please, check `SHIELDNET_DEFEND_HOME/logs/ossec.log`, `SHIELDNET_DEFEND_HOME/logs/cluster.log` and '
                              '`SHIELDNET_DEFEND_HOME/logs/api.log` to get more information about the error'},
        ...
        1005: {'message': 'Error reading file',
               'remediation': 'Please, ensure you have the right file permissions in ShieldnetDefend directories'},
        1006: {'message': 'File/directory does not exist or there is a problem with the permissions',
               'remediation': 'Please, check if path to file/directory is correct and `shieldnetdefend` '
        ...
        1013: {'message': 'Unable to connect with socket',
               'remediation': 'Please, restart ShieldnetDefend to restore sockets'},
        ...
        1016: {'message': 'Error moving file',
               'remediation': 'Please, ensure you have the required file permissions in ShieldnetDefend directories'},
        1017: 'Some ShieldnetDefend daemons are not ready yet in node "{node_name}" ({not_ready_daemons})',
        1018: 'Body request is not a valid JSON',
        1019: 'Error trying to create backup file',
        1020: {'message': 'Could not find any ShieldnetDefend log file',
               'remediation': 'Please check `SHIELDNET_DEFEND_HOME/logs`'},

        # Configuration: 1100 - 1199
        1101: {'message': 'Requested component does not exist',
               'remediation': 'Run `SHIELDNET_DEFEND_PATH/bin/shieldnet-defend-logtest -t` to check your configuration'},
        1102: {'message': 'Invalid section',
               'remediation': f'Please, visit the official documentation (https://documentation.shieldnetdefend.com/'
        ...
        1106: {'message': 'Requested section not present in configuration',
               'remediation': 'Please, check your configuration file. '
                              f'You can visit the official documentation (https://documentation.shieldnetdefend.com/'
                              f'{DOCU_VERSION}/user-manual/reference/ossec-conf/index.html) '
                              'to get more information about configuration sections'},
        ...
        1114: "ShieldnetDefend syntax error",
        ...
        1119: "Directory '/tmp' needs read, write & execution permission for 'shieldnetdefend' user",
        ...
        1122: {'message': 'Experimental features are disabled',
               'remediation': 'Experimental features can be enabled in SHIELDNET_DEFEND_PATH/api/configuration/api.yaml'},
        1123: {
        ...
        1124: {'message': 'Remote command detected',
               'remediation': f'To solve this issue, please enable the remote commands in the API settings or add an '
                              f'exception: https://documentation.shieldnetdefend.com/{DOCU_VERSION}/user-manual/api/'
        ...
        1126: {'message': 'Error updating ossec configuration',
               'remediation': 'Please, ensure `SHIELDNET_DEFEND_PATH/etc/ossec.conf` has the proper permissions and ownership.'
               },
        1127: {'message': 'Protected section was modified',
               'remediation': 'To solve this, either revert the changes made to this section or disable the protection '
                              'in the API settings: '
                              f"https://documentation.shieldnetdefend.com/{DOCU_VERSION}/user-manual/api/configuration.html"},
        ...
        1129: {'message': 'Higher version agents detected',
               'remediation': f'To solve this issue, please enable agents higher versions in the API settings: '
                              f'https://documentation.shieldnetdefend.com/{DOCU_VERSION}/user-manual/api/'
        ...
        1131: {'message': 'Virus Total API request error',
               'remediation': 'The use of Virus Total Public API keys is disabled but could not be checked. '
                              ...
                              f"https://documentation.shieldnetdefend.com/{DOCU_VERSION}/user-manual/api/configuration.html"},
        # Rule: 1200 - 1299
        1200: {'message': 'Error reading rules from `SHIELDNET_DEFEND_HOME/etc/ossec.conf`',
               'remediation': f'Please, visit the official documentation (https://documentation.shieldnetdefend.com/'
                              f'{DOCU_VERSION}/user-manual/reference/ossec-conf/index.html)'
        ...
        1209: {'message': 'Invalid relative directory. A \'rule_dir\' tag must '
               ...
               'remediation': f'Please, visit the official documentation '
                              f'(https://documentation.shieldnetdefend.com/'
        ...
        1211: {'message': 'Invalid relative directory. A \'rule_dir\' tag is declared in ossec.conf '
               ...
               'remediation': f'Please, visit the official documentation'
                               '(https://documentation.shieldnetdefend.com/'
                              f'{DOCU_VERSION}/user-manual/reference/ossec-conf/ruleset.html)'
                              ' to get more information about the rules'
               },
        ...
        1307: {'message': 'Invalid parameters',
               'remediation': 'Please, check that the update is correct, there is a problem while reading the results, '
                              'contact us at [official repository](https://github.com/shieldnetdefend/shieldnetdefend/issues)'
               },
        ...
        1707: {'message': 'Cannot send request, agent is not active',
               'remediation': 'Please, check non-active agents connection and try again. Visit '
                              f'https://documentation.shieldnetdefend.com/{DOCU_VERSION}/user-manual/registering/index.html and '
                              f'https://documentation.shieldnetdefend.com/{DOCU_VERSION}/user-manual/agents/agent-connection.'
        ...
        1726: {'message': 'ShieldnetDefend authd is not running',
        ...
        1728: {'message': 'Invalid node type',
               'remediation': f'Valid types are `master` and `worker`. Please, visit https://documentation.shieldnetdefend.com/'
        ...
        1730: {'message': 'Node does not exist',
               'remediation': 'Make sure the name is correct and that the node is up. You can check it using '
                              f'`cluster_control -l` (https://documentation.shieldnetdefend.com/{DOCU_VERSION}/user-manual/'
        ...
        1734: {'message': 'Error removing agent from group',
               'remediation': f'Agent does not belong to specified group, to assign the agent to a group follow: '
                              f'https://documentation.shieldnetdefend.com/{DOCU_VERSION}/user-manual/agents/grouping-agents.html'
               },
        1735: {'message': 'Agent version is not compatible with this feature',
               'remediation': 'Please update the agent, in case the problem persists contact us at: https://github.com'
                              '/shieldnetdefend/shieldnetdefend/issues'
               },
        ...
        1743: 'Error running ShieldnetDefend syntax validator',
        ...
        1750: {'message': 'Could not send restart command, active-response is disabled in the agent',
               'remediation': "You can activate it in agents' `SHIELDNET_DEFEND_HOME/etc/ossec.conf`"},
        ...
        1914: {'message': 'Failed to reload ruleset',
               'remediation': 'Check the ShieldnetDefend logs for details and verify the ruleset files and permissions.'},
        ...
        2003: {'message': 'Error in shieldnetdefenddb request',
        ...
        2006: {'message': 'Received JSON from ShieldnetDefend DB is not correctly formatted'},
        2007: {'message': 'Error retrieving data from ShieldnetDefend DB'},
        2008: {'message': 'Corrupted RBAC database',
               'remediation': 'Restart the ShieldnetDefend service to restore the RBAC database to default'},
        2009: {'message': 'Pagination error. Response from shieldnet-defend-db was over the maximum socket buffer size'},
        2010: {'message': 'The requested read operation did not complete fully'},
        2011: {'message': 'Could not connect to the shieldnet-defend-db unix socket'},
        2012: {'message': 'Invalid shieldnet-defend-db HTTP request'},
        2013: {'message': 'Error sending HTTP request'},
        2014: {'message': 'The shieldnet-defend-db client connection timeout has been exceeded'},
        2015: {'message': 'Invalid request URL scheme'},
        2016: {'message': 'Invalid unix socket path'},
        2017: {'message': 'Could not retrieve agents synchronization information from shieldnet-defend-db'},
        ...
        3013: {'message': 'Cluster is not running, it might be disabled in `SHIELDNET_DEFEND_HOME/etc/ossec.conf`',
               'remediation': f'Please, visit the official documentation (https://documentation.shieldnetdefend.com/'
                              f'{DOCU_VERSION}/user-manual/configuring-cluster/index.html)'
                              ' to get more information about how to configure a cluster'
               },
        ...
        3019: 'ShieldnetDefend is running in cluster mode: {EXECUTABLE_NAME} is not available in worker nodes. Please, '
        ...
        3023: {'message': 'Worker node is not connected to master',
               'remediation': 'Check the cluster.log located at SHIELDNET_DEFEND_HOME/logs/cluster.log file to see if there are '
                              'connection errors. Restart the `shieldnet-defend-manager` service.'},
        3024: "Length of command exceeds limit defined in shieldnetdefend.cluster.common.Handler.cmd_len.",
        3025: {'message': "Could not decrypt message",
               'remediation': "Check the cluster key is correct in the worker's "
                              f"[ossec.conf](https://documentation.shieldnetdefend.com/{DOCU_VERSION}/user-manual/reference/"
        ...
        3028: {'message': "Worker node ID already exists",
               'remediation': f"Check and fix [worker names](https://documentation.shieldnetdefend.com/{DOCU_VERSION}/"
                              f"user-manual/reference/ossec-conf/cluster.html#node-name)"
                              " and restart the `shieldnet-defend-manager` service."},
        3029: {"message": "Connected worker with same name as the master",
               "remediation": f"Check and fix the [worker name](https://documentation.shieldnetdefend.com/{DOCU_VERSION}/"
                              f"user-manual/reference/ossec-conf/cluster.html#node-name)"
                              " and restart the `shieldnet-defend-manager` service in the node"},
        3030: {'message': 'Worker does not belong to the same cluster',
               'remediation': f"Change the [cluster name](https://documentation.shieldnetdefend.com/{DOCU_VERSION}/"
                              f"user-manual/reference/ossec-conf/cluster.html#name)"
                              " in the worker configuration to match the master's and restart the `shieldnet-defend-manager` "
                              "service"},
        3031: {'message': "Worker and master versions are not the same",
               'remediation': f"[Update](https://documentation.shieldnetdefend.com/{DOCU_VERSION}/upgrade-guide/index.html)"
        ...
        4000: {'message': "Permission denied",
               'remediation': "Please, make sure you have permissions to execute the current request. "
                              ...
                              f"shieldnetdefend.com/{DOCU_VERSION}/user-manual/api/rbac/configuration.html"},
        ...
        4008: {'message': 'The specified resource is required for a correct ShieldnetDefend\'s functionality'},
        ...
        4019: {'message': 'Invalid resource specified',
               'remediation': f'Please, check the current RBAC resources, for more information please visit https:/'
                              f'/documentation.shieldnetdefend.com/{DOCU_VERSION}/user-manual/api/rbac/configuration.html'},
        ...
        5008: {'message': 'The current user cannot be deleted',
               'remediation': 'You can delete this user with the administrator user (shieldnetdefend) or '
        ...
        6001: {'message': 'Maximum number of requests per minute reached',
               'remediation': f'This limit can be changed in api.yaml file. More information here: https:/'
                              f'/documentation.shieldnetdefend.com/{DOCU_VERSION}/user-manual/api/configuration.html#'
        ...
        6003: {'message': 'Error trying to load the JWT secret',
               'remediation': 'Make sure you have the right permissions: SHIELDNET_DEFEND_PATH/api/configuration/security/'
                              'jwt_secret'},
        6004: {'message': 'The current user does not have authentication enabled through authorization context',
               'remediation': f'You can enable it using the following endpoint: https://documentation.shieldnetdefend.com/'
                              f'{DOCU_VERSION}/user-manual/api/reference.html#operation/api.controllers.'
    ...
    def __init__(self, code: int, extra_message: str = None, extra_remediation: str = None, cmd_error: bool = False,
        ...
        """Create a ShieldnetDefendException object.
        ...
        dapi_errors : dict
            Dictionary with details about node and logfile. I.e.: {'master-node': {'error': 'ShieldnetDefend Internal error',
            'logfile': SHIELDNET_DEFEND_HOME/logs/api.log}}
        title : str
    ...
    def __eq__(self, other):
        if not isinstance(other, ShieldnetDefendException):
    ...
    def __or__(self, other):
        if isinstance(other, ShieldnetDefendException):
...
class ShieldnetDefendInternalError(ShieldnetDefendException):
    """
    ...
    _default_title = "ShieldnetDefend Internal Error"

    def __init__(self, code: int, extra_message: str = None, extra_remediation: str = None, cmd_error: bool = False,
                 dapi_errors: dict = None, ids: Union[list, set] = None, title: str = None, type: str = None):
        """Create a ShieldnetDefendInternalError exception.
...
class ShieldnetDefendClusterError(ShieldnetDefendInternalError):
    """
    This type of exception is raised inside the cluster.
    """
    _default_type = "about:blank"
    _default_title = "ShieldnetDefend Cluster Error"


class ShieldnetDefendHAPHelperError(ShieldnetDefendClusterError):
    """
...
class ShieldnetDefendError(ShieldnetDefendException):
    """
    ...
    def __init__(self, code: int, extra_message: str = None, extra_remediation: str = None, cmd_error: bool = False,
                 dapi_errors: dict = None, ids: Union[list, set] = None, title: str = None, type: str = None):
        """Create a ShieldnetDefendError exception.
    ...
    def __or__(self, other):
        result: ShieldnetDefendError = super().__or__(other)
        if isinstance(result, ShieldnetDefendError):
...
class ShieldnetDefendPermissionError(ShieldnetDefendError):
    """
...
class ShieldnetDefendResourceNotFound(ShieldnetDefendError):
    """
...
class ShieldnetDefendTooManyRequests(ShieldnetDefendError):
    """
...
class ShieldnetDefendNotAcceptable(ShieldnetDefendError):
    """
