...
class ShieldnetDefendAgent:
    """Tools to handle ShieldnetDefend agents connections."""
...
class ShieldnetDefendDAPI:
    """Class to call ShieldnetDefend DAPI functions."""
    ...
    def _get_logger(tag: str) -> logging.Logger:
        ...
        """
        logger = logging.getLogger('shieldnetdefend').getChild('ShieldnetDefendDAPI')
