...
from shieldnetdefend.core.syscollector import ShieldnetDefendDBQuerySyscollector
...
def get_ciscat_results(agent_list: list = None, offset: int = 0, limit: int = common.DATABASE_LIMIT,
                       ...
                       nested: bool = True, array: bool = True, q: str = '') -> AffectedItemsShieldnetDefendResult:
