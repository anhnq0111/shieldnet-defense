    ...
    with patch('shieldnetdefend.core.common.shieldnet_defend_uid'), patch('shieldnetdefend.core.common.shieldnet_defend_gid'):
        with patch('sqlalchemy.create_engine', return_value=default_orm_engine):
            with patch('shutil.chown'), patch('os.chmod'):
                ...
                import shieldnetdefend.rbac.decorators as decorators
        ...
        with patch('sqlalchemy.create_engine', return_value=create_engine("sqlite://")):
            with patch('shutil.chown'), patch('os.chmod'):
                with patch('api.constants.SECURITY_PATH', new=test_data_path):
                    ...
                    from shieldnetdefend.core import security as core_security
    try:
        create_memory_db('schema_security_test.sql', orm.db_manager.sessions[orm.DB_FILE])
    except OperationalError:
        pass

    yield security, ShieldnetDefendResult, core_security
    orm.db_manager.close_sessions()
