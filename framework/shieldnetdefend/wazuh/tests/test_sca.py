...
with patch('shieldnetdefend.core.common.shieldnet_defend_uid'):
    with patch('shieldnetdefend.core.common.shieldnet_defend_gid'):
        ...
        from shieldnetdefend.sca import get_sca_checks, get_sca_list
...
@patch('shieldnetdefend.core.sca.ShieldnetDefendDBQuerySCA.run', return_value={'items': ['test_items'], 'totalItems': 100})
@patch('shieldnetdefend.core.sca.ShieldnetDefendDBQuerySCA.__exit__')
@patch('shieldnetdefend.core.sca.ShieldnetDefendDBQuerySCA.__init__', return_value=None)
@patch('shieldnetdefend.core.agent.Agent.get_basic_information')
@patch('shieldnetdefend.sca.get_agents_info', return_value=['000'])
def test_get_sca_list(mock_get_agents_info, mock_get_basic_information, mock_Shieldnet_DefendDBQuerySCA__init__,
                      mock_Shieldnet_DefendDBQuerySCA__exit__, mock_Shieldnet_DefendDBQuerySCA_run):
    ...
    mock_Shieldnet_DefendDBQuerySCA__init__.assert_called_once_with(agent_id='000', query='name~value', count=True,
...
@patch('shieldnetdefend.sca.get_agents_info', return_value=[])
...
@patch('shieldnetdefend.core.sca.ShieldnetDefendDBQuerySCACheckRelational.run', side_effect=[TEST_SCA_CHECKS_COMPLIANCE,
                                                                         TEST_SCA_CHECKS_RULES])
@patch('shieldnetdefend.core.sca.ShieldnetDefendDBQuerySCACheckRelational.__init__', return_value=None)
@patch('shieldnetdefend.core.sca.ShieldnetDefendDBQuerySCACheck.run', return_value=TEST_SCA_CHECKS)
@patch('shieldnetdefend.core.sca.ShieldnetDefendDBQuerySCACheck.__init__', return_value=None)
@patch('shieldnetdefend.core.sca.ShieldnetDefendDBQuerySCACheckIDs.run', return_value=TEST_SCA_CHECKS_IDS)
@patch('shieldnetdefend.core.sca.ShieldnetDefendDBQuerySCACheckIDs.__init__', return_value=None)
@patch('shieldnetdefend.core.sca.ShieldnetDefendDBQuery.__exit__')
@patch('shieldnetdefend.core.agent.Agent.get_basic_information')
@patch('shieldnetdefend.sca.get_agents_info', return_value=['000'])
def test_get_sca_checks(mock_get_agents_info, mock_get_basic_information, mock_Shieldnet_DefendDBQuery__exit__,
                        mock_Shieldnet_DefendDBQuerySCACheckIDs__init__, mock_Shieldnet_DefendDBQuerySCACheckIDs_run,
                        mock_Shieldnet_DefendDBQuerySCACheck__init__, mock_Shieldnet_DefendDBQuerySCACheck_run,
                        mock_Shieldnet_DefendDBQuerySCACheckRelational__init__, mock_Shieldnet_DefendDBQuerySCACheckRelational_run):
    ...
    # Assertions
    mock_Shieldnet_DefendDBQuerySCACheckIDs__init__.assert_called_once_with(agent_id=agent_id, offset=offset, limit=limit,
                                                                 filters=filters, search=search, query=q,
                                                                 policy_id=policy_id, sort=sort)
    id_check_list = [item['id'] for item in mock_Shieldnet_DefendDBQuerySCACheckIDs_run.return_value['items']]
    mock_Shieldnet_DefendDBQuerySCACheck__init__.assert_called_once_with(agent_id=agent_id, sort=sort, select=select,
                                                              sca_checks_ids=id_check_list)
    mock_Shieldnet_DefendDBQuerySCACheckRelational__init__.assert_has_calls(
...
@patch('shieldnetdefend.core.sca.ShieldnetDefendDBQueryDistinctSCACheck.run', return_value={'items': ['test_items'], 'totalItems': 100})
@patch('shieldnetdefend.core.sca.ShieldnetDefendDBQueryDistinctSCACheck.__init__', return_value=None)
@patch('shieldnetdefend.core.sca.ShieldnetDefendDBQuery.__exit__')
@patch('shieldnetdefend.core.agent.Agent.get_basic_information')
@patch('shieldnetdefend.sca.get_agents_info', return_value=['000'])
def test_get_sca_checks_distinct(mock_get_agents_info, mock_get_basic_information, mock_Shieldnet_DefendDBQuery__exit__,
                                 mock_Shieldnet_DefendDBQueryDistinctSCACheck__init__, mock_Shieldnet_DefendDBQueryDistinctSCACheck_run):
    ...
    # Assertions
    mock_Shieldnet_DefendDBQueryDistinctSCACheck__init__.assert_called_once_with(agent_id=agent_id, offset=offset, limit=limit,
                                                                      filters=filters, search=search, query=q,
...
@patch('shieldnetdefend.core.sca.ShieldnetDefendDBQuerySCACheckRelational.run')
@patch('shieldnetdefend.core.sca.ShieldnetDefendDBQuerySCACheckRelational.__init__', return_value=None)
@patch('shieldnetdefend.core.sca.ShieldnetDefendDBQuerySCACheck.run')
@patch('shieldnetdefend.core.sca.ShieldnetDefendDBQuerySCACheck.__init__', return_value=None)
@patch('shieldnetdefend.core.sca.ShieldnetDefendDBQuerySCACheckIDs.run', return_value=TEST_SCA_CHECKS_IDS)
@patch('shieldnetdefend.core.sca.ShieldnetDefendDBQuerySCACheckIDs.__init__', return_value=None)
@patch('shieldnetdefend.core.sca.ShieldnetDefendDBQuery.__exit__')
@patch('shieldnetdefend.core.agent.Agent.get_basic_information')
@patch('shieldnetdefend.sca.get_agents_info', return_value=['000'])
def test_get_sca_checks_select(mock_get_agents_info, mock_get_basic_information, mock_Shieldnet_DefendDBQuery__exit__,
                               mock_Shieldnet_DefendDBQuerySCACheckIDs__init__, mock_Shieldnet_DefendDBQuerySCACheckIDs_run,
                               mock_Shieldnet_DefendDBQuerySCACheck__init__, mock_Shieldnet_DefendDBQuerySCACheck_run,
                               mock_Shieldnet_DefendDBQuerySCACheckRelational__init__, mock_Shieldnet_DefendDBQuerySCACheckRelational_run,
    ...
    # Assertions
    mock_Shieldnet_DefendDBQuerySCACheckIDs__init__.assert_called_once()
    mock_Shieldnet_DefendDBQuerySCACheck__init__.assert_called_once_with(agent_id=agent_id, select=exp_select_check, sort=None,
                                                              sca_checks_ids=[1, 2, 3])

    # Assert ShieldnetDefendDBQuerySCACheckRelational__init__ was called only when necessary
    calls = []
    ...
    mock_Shieldnet_DefendDBQuerySCACheckRelational__init__.assert_has_calls(calls, any_order=False)
