...
from shieldnetdefend.core.results import AffectedItemsShieldnetDefendResult, merge
from shieldnetdefend.core.syscollector import ShieldnetDefendDBQuerySyscollector, get_valid_fields, Type
...
def get_item_agent(agent_list: list, offset: int = 0, limit: int = common.DATABASE_LIMIT, select: dict = None,
                   ...
                   nested: bool = True, element_type: str = 'os', distinct: bool = False) -> AffectedItemsShieldnetDefendResult:
    ...
    for agent in agent_list:
        try:
            ...
            with ShieldnetDefendDBQuerySyscollector(agent_id=agent, offset=offset, limit=limit, select=select,
                                          search=search,
        ...
        except ShieldnetDefendResourceNotFound as e:
