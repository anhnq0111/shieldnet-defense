...
with patch('shieldnetdefend.core.common.shieldnet_defend_uid'):
    with patch('shieldnetdefend.core.common.shieldnet_defend_gid'):
        from shieldnetdefend.core import sca as core_sca
...
@patch('shieldnetdefend.core.utils.ShieldnetDefendDBBackend.__init__', return_value=None)
@patch('shieldnetdefend.core.utils.ShieldnetDefendDBQuery.__init__')
def test_Shieldnet_DefendDBQuerySCA__init__(mock_wdbq, mock_backend, mock_get_basic_info, distinct, agent_id, offset, limit, sort,
                                 search, query, count, get_data, select):
    """Test if method __init__ of ShieldnetDefendDBQuerySCA works properly.
    ...
    """
    wdbq_sca = core_sca.ShieldnetDefendDBQuerySCA(agent_id=agent_id, offset=offset, limit=limit, sort=sort, search=search,
    ...
    mock_wdbq.assert_called_once_with(ANY, offset=offset, limit=limit, table='sca_policy', sort=sort, search=search,
                                      select=select, fields=core_sca.ShieldnetDefendDBQuerySCA.DB_FIELDS,
...
def test_Shieldnet_DefendDBQuerySCA__format_data_into_dictionary(agent_id, offset, limit, sort, search, select, query, count,
                                                      get_data):
    """Check if ShieldnetDefendDBQuerySCA's method _format_data_into_dictionary works properly.
...
@patch('shieldnetdefend.core.sca.ShieldnetDefendDBQuerySCA.__init__')
def test_Shieldnet_DefendDBQuerySCACheck__init__(mock_wdbqsca, select, sca_checks_test_list, expected_default_query):
    """Test if method __init__ of ShieldnetDefendDBQuerySCACheck works properly.
    ...
    """
    core_sca.ShieldnetDefendDBQuerySCACheck(agent_id='000', select=select, sort={'fields': ['title'], 'order': 'asc'},
...
def test_Shieldnet_DefendDBQuerySCACheck_parse_select_filter(mock_exists, mock_get_basic_info, mock_backend):
    """Test if method _parse_select_filter of ShieldnetDefendDBQuerySCACheck works properly."""
    wdbq_sca_check = core_sca.ShieldnetDefendDBQuerySCACheck(agent_id='000', sort={'value': 'test'},
...
@patch('shieldnetdefend.core.sca.ShieldnetDefendDBQuerySCA.__init__')
def test_Shieldnet_DefendDBQuerySCACheckIDs__init__(mock_wdbqsca, query):
    """Test if method __init__ of ShieldnetDefendDBQuerySCACheckIDs works properly.

    Parameters
    ----------
    query : str
        Query used to initialize the ShieldnetDefendDBQuerySCACheckIDs object.
    """
    ...
    core_sca.ShieldnetDefendDBQuerySCACheckIDs(agent_id='000', offset=10, limit=20, filters={'test': 'value'},
                                     search={'value': 'test'},
...
@patch('shieldnetdefend.core.utils.ShieldnetDefendDBBackend.__init__', return_value=None)
@patch('shieldnetdefend.core.agent.Agent.get_basic_information')
def test_Shieldnet_DefendDBQuerySCACheckIDs_protected_pass_filter(mock_get_basic_info, mock_backend, field, value, expected):
    """Test ShieldnetDefendDBQuerySCACheckIDs._pass_filter function."""
    query = core_sca.ShieldnetDefendDBQuerySCACheckIDs(agent_id='000', offset=10, limit=20, filters={'test': 'value'},
...
@patch('shieldnetdefend.core.sca.ShieldnetDefendDBQuerySCA.__init__')
def test_Shieldnet_DefendDBQuerySCACheckRelational__init__(mock_wdbqsca, select, table, sca_checks_test_list):
    """Test if method __init__ of ShieldnetDefendDBQuerySCACheckRelational works properly.
    ...
    select : list or None
        Fields to select.
    table : str
        Table used to initialize the ShieldnetDefendDBQuerySCACheckRelational object.
    sca_checks_test_list : list
        List of SCA checks IDs.
    """
    query_sca_check_relational = core_sca.ShieldnetDefendDBQuerySCACheckRelational(agent_id='000', table=table,
...
@patch('shieldnetdefend.core.sca.ShieldnetDefendDBQuerySCA.__enter__')
...
def test_Shieldnet_DefendDBQueryDistinctSCACheck__init__(mock_exit, mock_wdbqsca, mock_enter, select):
    """Test if method __init__ of ShieldnetDefendDBQueryDistinctSCACheck works properly."""
    ...
    core_sca.ShieldnetDefendDBQueryDistinctSCACheck(agent_id='000', offset=10, limit=20, filters={'test': 'value'},
    ...
    mock_wdbqsca.assert_has_calls(
        [call(agent_id='000', offset=0, limit=None, sort={'fields': ['title'], 'order': 'asc'},
              ...
              default_query=core_sca.ShieldnetDefendDBQueryDistinctSCACheck.INNER_QUERY_PATTERN, search={'value': 'test'}),
