...
title: 'Release [SHIELDNETDEFEND VERSION] - [STAGE] - System tests'
...
These requirements should be requested to the @shieldnetdefend/devel-devops team via https://github.com/shieldnetdefend/internal-devel-requests.

For further information, check https://github.com/shieldnetdefend/shieldnet-defend-qa/tree/main/tests/system/README.md
...
- [ ] @shieldnetdefend/devel-qa-release
