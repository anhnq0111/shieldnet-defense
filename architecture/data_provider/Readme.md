...
# ShieldnetDefend module: Data Provider architecture
## Index
- [ShieldnetDefend module: Data Provider architecture](#shieldnet-defend-module-data-provider-architecture)
  - [Index](#index)
  - [Purpose](#purpose)
...
- DBSync: This module has one single main responsibility: Database management. It manages all database related operations like insertion, update, selection and deletion. This allows ShieldnetDefend to centralize and unify database management to make it more robust and to avoid possible misleading data.
- RSync: It is in charge of database synchronization between ShieldnetDefend agents DBs and ShieldnetDefend  manager DBs (each agent DB). RSync implements a unified and generic communication algorithm used to maintain ShieldnetDefend agents and ShieldnetDefend manager datasets consistency.
