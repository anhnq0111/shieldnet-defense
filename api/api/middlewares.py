...
# API secure headers
server = Server().set("ShieldnetDefend")
...
class ShieldnetDefendAccessLoggerMiddleware(BaseHTTPMiddleware):
    """Middleware to log custom Access messages."""

    async def dispatch(self, request: Request, call_next: RequestResponseEndpoint) -> Response:
        """Log ShieldnetDefend access information.
        ...
        if body:
            try:
                ...
                # Related to https://github.com/shieldnetdefend/shieldnetdefend/issues/24060.
