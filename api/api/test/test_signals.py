...
def installation_uid_mock():
    with patch(
        'shieldnetdefend.core.common.INSTALLATION_UID_PATH', os.path.join('/tmp', INSTALLATION_UID_KEY)
    ) as path_mock:
        yield path_mock
