...
- Test the mapping
    Run the script with a relative path from the `shieldnetdefend` folder to check if a file is mapped.
    ```
    python3 _test_mapping.py framework/shieldnetdefend/agent.py
    ```
    ...
    > **NOTE:** Please use a relative path when trying the testing mode. For instance: `/home/shieldnetdefend/Desktop/git/shieldnetdefend/framework/shieldnetdefend/agent.py` -> `framework/shieldnetdefend/agent.py`
