...
/// Enumeration of communication with ShieldnetDefend DB components.
typedef enum
{
...
/// Enumeration of communication with ShieldnetDefend DB status.
 ...
 *
 * @param[in] sock A ShieldnetDefend DB socket connection.
