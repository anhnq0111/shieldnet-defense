...
/**
 * Function with all the necessary functionality to process the uninstallation validation of the ShieldnetDefend agent package.
...
static const char AG_IN_UNMERGE[] = "shieldnetdefend: Could not unmerge shared file.";
