...
#define SMS_SUBJECT         "ShieldnetDefend %d - %d - %s"
#define MAIL_SUBJECT        "ShieldnetDefend notification - %s - Alert level %d"
#define MAIL_SUBJECT_FULL   "ShieldnetDefend alert - %s - Level %d - %s"
