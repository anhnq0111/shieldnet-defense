...
public:
    ...
    {
        std::cout << "\nUsage: shieldnet-defend-keystore <option(s)>\n"
                  << "Options:\n"
                  ...
                  << "\nExample:"
                  << "\n\t./shieldnet-defend-keystore -f indexer -k username -v admin\n"
                  << "\n\t./shieldnet-defend-keystore -f indexer -k password -vp /path/to/file.txt\n"
                  << "\n\t./shieldnet-defend-keystore -f indexer -k password < /path/to/file.txt\n"
                  << "\n\techo 'pass' | ./shieldnet-defend-keystore -f indexer -k password\n"
                  << "\n\tcat /path/to/file.txt | ./shieldnet-defend-keystore -f indexer -k password\n"
                  << std::endl;
    }
