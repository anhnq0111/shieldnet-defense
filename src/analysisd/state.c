 ...
 * @param sock ShieldnetDefend DB socket
 */
...
void w_inc_decoded_by_component_events(const char *component, const char *agent_id) {
    if (component != NULL) {
        if (!strcmp(component, "shieldnet-defend-agent")) {
            w_inc_agent_decoded_events(agent_id);
        } else if (!strcmp(component, "shieldnet-defend-agentlessd")) {
            w_inc_agentless_decoded_events(agent_id);
        } else if (!strcmp(component, "shieldnet-defend-monitord")) {
            w_inc_monitor_decoded_events(agent_id);
        } else if (!strcmp(component, "shieldnet-defend-remoted")) {
        ...
        } else if (!strcmp(component, "aws-s3") || !strcmp(component, "Shieldnet-Defend-AWS")) {
        ...
        } else if (!strcmp(component, "docker-listener") || !strcmp(component, "Shieldnet-Defend-Docker")) {
            w_inc_modules_docker_decoded_events(agent_id);
        } else if (!strcmp(component, "gcp-pubsub") || !strcmp(component, "gcp-bucket") || !strcmp(component, "Shieldnet-Defend-GCloud")) {
