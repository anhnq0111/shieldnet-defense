...
extern int wm_max_eps;          // Maximum events per second sent by OpenScap ShieldnetDefend Module
...
/*
 * @brief Get ID group of ShieldnetDefend user.
 *
 * @return ID group.
 */
...
/*
 * @brief Set ID group of shieldnetdefend modules
 *
