...
void InventoryHarvesterFacade::initShieldnetDefendDBAgentEventSubscription()
{
...
// void InventoryHarvesterFacade::initShieldnetDefendDBFimEventSubscription()
// {
...
void InventoryHarvesterFacade::initShieldnetDefendDBInventoryEventSubscription()
{
    ...
    const nlohmann::json& configuration)
{
    try
    {
        ...
        initShieldnetDefendDBAgentEventSubscription();
        initShieldnetDefendDBInventoryEventSubscription();
        // initShieldnetDefendDBFimEventSubscription(); // DISABLED: FIM events are no longer processed.
