...
private:
    ...
    void initShieldnetDefendDBAgentEventSubscription();
    // void initShieldnetDefendDBFimEventSubscription(); // DISABLED: FIM events are no longer processed.
    void initShieldnetDefendDBInventoryEventSubscription();
