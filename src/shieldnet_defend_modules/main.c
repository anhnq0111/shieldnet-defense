...
int main(int argc, char **argv)
{
    ...
    wmodule *cur_module;
    wm_debug_level = getDefine_Int("shieldnet_defend_modules", "debug", 0, 2);
    ...
    int nofile = getDefine_Int("shieldnet_defend_modules", "rlimit_nofile", 8192, 1048576);
...
void wm_help()
{
    print_out("ShieldnetDefend Module Manager - %s\nShieldnetDefend Inc.", __ossec_version);
    print_out(" ");
...
void wm_handler(int signum)
{
    ...
    case SIGTERM:
        ...
        minfo("Shutting down ShieldnetDefend modules.");
