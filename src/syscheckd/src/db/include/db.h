 ...
 * @return cJSON array containing all synced table elements (must be freed with cJSON_Delete), NULL on error.
 */
EXPORTED cJSON* fim_db_get_every_sync_element(const char* table_name);
