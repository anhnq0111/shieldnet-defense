...
#include "../wrappers/shieldnetdefend/os_auth/os_auth_wrappers.h"
...
static void test_w_generate_random_pass_success(void **state) {
    ...
    will_return(__wrap_GetRandomNoise, strdup("ShieldnetDefend"));
    ...
    will_return_always(__wrap_getuname, "Linux |ubuntu-focal |5.4.0-92-generic |#103-Ubuntu SMP Fri Nov 26 16:13:00 UTC 2021 "
                                        "|x86_64 [Ubuntu|ubuntu: 20.04.2 LTS (Focal Fossa)] - ShieldnetDefend v4.3.4");
