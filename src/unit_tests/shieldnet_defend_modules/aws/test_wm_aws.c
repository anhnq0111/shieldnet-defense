...
#include "../../../shieldnet_defend_modules/wm_aws.h"
...
static int setup_module() {
    ...
    const char *string =
        ...
        "<bucket type=\"config\">\n"
        "    <name>shieldnet-defend-aws-wodle</name>\n"
        "    <path>config</path>\n"
...
void test_interval_execution(void **state) {
    ...
    *state = module_data;
    ...
    expect_string_count(__wrap__mterror, tag, "shieldnet-defend-modulesd:aws-s3", TEST_MAX_DATES + 1);
