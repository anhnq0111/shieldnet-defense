...
#include "../../shieldnet_defend_modules/agent_upgrade/agent/wm_agent_upgrade_agent.h"
...
void test_wm_upgrade_agent_send_ack_message_error_exit(void **state)
{
    ...
    expect_string(__wrap__mterror_exit, tag, "shieldnet-defend-modulesd:agent-upgrade");
