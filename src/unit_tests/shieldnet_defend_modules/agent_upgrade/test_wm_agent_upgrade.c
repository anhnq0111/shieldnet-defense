...
#include "../../wrappers/shieldnetdefend/shieldnet_defend_modules/wm_agent_upgrade_agent_wrappers.h"

#include "../../shieldnet_defend_modules/wmodules.h"
#include "../../shieldnet_defend_modules/agent_upgrade/wm_agent_upgrade.h"
...
void test_wm_agent_upgrade_dump_enabled(void **state)
{
    ...
    #ifdef TEST_SERVER
    os_strdup("shieldnetdefend.com/packages", config->manager_config.wpk_repository);
    ...
    assert_string_equal(cJSON_GetObjectItem(conf, "wpk_repository")->valuestring, "shieldnetdefend.com/packages");
    #else
