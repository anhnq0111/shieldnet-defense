...
#include "../../wrappers/shieldnetdefend/shared/cluster_op_wrappers.h"
...
#include "../../wrappers/shieldnetdefend/shieldnet_defend_modules/wm_task_manager_wrappers.h"

#include "../../shieldnet_defend_modules/wmodules.h"
#include "../../shieldnet_defend_modules/task_manager/wm_task_manager.h"
#include "../../shieldnet_defend_modules/task_manager/wm_task_manager_tasks.h"
...
void test_wm_task_manager_destroy(void **state)
{
    ...
    expect_string(__wrap__mtinfo, tag, "shieldnet-defend-modulesd:task-manager");
...
void test_wm_task_manager_init_bind_err(void **state)
{
    ...
    expect_string(__wrap__mterror, tag, "shieldnet-defend-modulesd:task-manager");
...
void test_wm_task_manager_dispatch_ok(void **state)
{
    ...
    expect_string(__wrap__mtdebug1, tag, "shieldnet-defend-modulesd:task-manager");
