...
DAEMONS="shieldnet-defend-modulesd shieldnet-defend-monitord shieldnet-defend-logcollector shieldnet-defend-syscheckd shieldnet-defend-analysisd shieldnet-defend-maild shieldnet-defend-execd shieldnet-defend-db shieldnet-defend-agentlessd shieldnet-defend-integratord shieldnet-defend-dbd shieldnet-defend-csyslogd"
...
start_service()
{
    ...
    TEST=$(${DIR}/bin/shieldnet-defend-logtest-legacy -t  2>&1)
    echo $TEST

    if [ ! -z "$TEST" ]; then
        echo "shieldnet-defend-analysisd: Configuration error. Exiting."
    ...
    if [ $? = 0 ]; then
        ...
        ${DIR}/ossec-agent/bin/shieldnet-defend-control start
    fi
...
stop_service()
{
    ...
    if [ $? = 0 ]; then
        ...
        ${DIR}/ossec-agent/bin/shieldnet-defend-control stop
    fi
