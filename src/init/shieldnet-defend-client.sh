...
DAEMONS="shieldnet-defend-modulesd shieldnet-defend-logcollector shieldnet-defend-syscheckd shieldnet-defend-agentd shieldnet-defend-execd"
...
check_folders()
{
    ...
    if [ ! -d $ALERTS_FOLDER ]
    then
        if rm -rf $ALERTS_FOLDER && mkdir -p $ALERTS_FOLDER && chown shieldnetdefend:shieldnetdefend $ALERTS_FOLDER && chmod 770 $ALERTS_FOLDER
        then
