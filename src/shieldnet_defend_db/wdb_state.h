...
typedef struct _shieldnet_defenddb_breakdown_t {
    uint64_t remove_queries;
    struct timeval remove_time;
} shieldnetdefenddb_breakdown_t;
...
typedef struct _queries_breakdown_t {
    ...
    uint64_t shieldnetdefenddb_queries;
    ...
    shieldnetdefenddb_breakdown_t shieldnetdefenddb_breakdown;
} queries_breakdown_t;
...
/**
 * @brief Increment total shieldnetdefenddb queries counter
 *
 */
void w_inc_shieldnet_defenddb();

/**
 * @brief Increment remove shieldnetdefenddb queries counter
 *
 */
void w_inc_shieldnet_defenddb_remove();

/**
 * @brief Increment remove shieldnetdefenddb time counter
 *
...
/**
 * @brief Create a JSON object with all the shieldnet-defend-db state information
 * @return JSON object
 */
