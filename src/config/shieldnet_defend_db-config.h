/*
 * Shieldnet-Defend-DB settings manager
...
#ifndef SHIELDNET_DEFEND_DB_CONFIG_H
#define SHIELDNET_DEFEND_DB_CONFIG_H
 ...
 */
int Read_Shieldnet_DefendDB(const OS_XML *xml, XML_NODE chld_node);

/**
 * @brief This method will read the "backup" configuration block of Shieldnet-Defend-DB.
 *
 * @param xml The configuration file to read.
 ...
 * @return int OS_SUCCESS if the configuration was read with no errors, OS_INVALID otherwise.
 */
int Read_Shieldnet_DefendDB_Backup(const OS_XML *xml, xml_node * node, int const BACKUP_NODE);
