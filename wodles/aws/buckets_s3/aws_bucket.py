...
RETRY_CONFIGURATION_URL = 'https://documentation.shieldnetdefend.com/current/amazon/services/prerequisites/' \
...
class AWSBucket(shieldnet_defend_integration.ShieldnetDefendAWSDatabase):
    """
    ...
    def __init__(self, db_table_name, bucket, reparse, access_key, secret_key, profile, iam_role_arn,
        ...
        shieldnet_defend_integration.ShieldnetDefendAWSDatabase.__init__(self,
        ...
        def exception_handler(error_txt, error_code):
            if self.skip_on_error:
                ...
                try:
                    ...
                    aws_tools.debug("++ Failed to send message to ShieldnetDefend", 1)
            else:
