...
def test_aws_inspector_send_describe_findings(mock_sts_client):
    ...
    with patch('shieldnet_defend_integration.ShieldnetDefendIntegration.send_msg') as mock_send_msg, \
...
@patch('shieldnet_defend_integration.ShieldnetDefendAWSDatabase.init_db')
@patch('shieldnet_defend_integration.ShieldnetDefendAWSDatabase.close_db')
