...
def test_aws_service_initializes_properly(mock_shieldnet_defend_integration, mock_version, mock_path, mock_client, mock_connect,
    ...
    mock_shieldnet_defend_integration.assert_called_with(instance, service_name=utils.TEST_SERVICE_NAME,
...
@patch('shieldnet_defend_integration.ShieldnetDefendIntegration.__init__', side_effect=shieldnet_defend_integration.ShieldnetDefendIntegration.__init__)
def test_aws_service_get_last_log_date(mock_shieldnet_defend_integration, mock_shieldnet_defend_aws_database, mock_sts):
...
@patch('shieldnet_defend_integration.ShieldnetDefendAWSDatabase.__init__')
@patch('shieldnet_defend_integration.ShieldnetDefendIntegration.__init__', side_effect=shieldnet_defend_integration.ShieldnetDefendIntegration.__init__)
def test_aws_service_format_message(mock_shieldnet_defend_integration, mock_shieldnet_defend_aws_database, mock_sts):
